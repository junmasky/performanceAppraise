...
import com.util.string.StringHelper;
...
public class DateHelper {
    ...
    public static boolean isWeekend(Date date){
        if (getWeekStr(date).endsWith("星期六") || getWeekStr(date).endsWith("星期日")){
            return true;
        }
        return false;
    }
     ...
     * @return
     */
    public static List<Date>getDatesBetweenTowDate(Date beginDate,Date endDate){
